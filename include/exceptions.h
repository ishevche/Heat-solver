...
#ifndef MPI_EXCEPTIONS_H
#define MPI_EXCEPTIONS_H
...
class NotStableSystem : public BaseException {
public:
    int get_exit_code() override { return 65; }
    using BaseException::BaseException;
};

class NotEnoughProcesses : public BaseException {
public:
    int get_exit_code() override { return 66; }
    using BaseException::BaseException;
};

#endif //MPI_EXCEPTIONS_H
